...
class ChargerLogic:
    def __init__(self, name, component):
        ...
        t1 = {
            "source": "searching",
            "target": "would_you_like_to_charge",
            "trigger": "found_scooter",
            "effect": "send_message_to_scooter",
        }
        t2 = {
            "source": "would_you_like_to_charge",
            "target": "searching",
            "trigger": "t0",
            "effect": "give_discount_2",
        }
        t3 = {
            "source": "would_you_like_to_charge",
            "target": "searching",
            "trigger": "yes_charge",
            "effect": "give_discount_5",
        }
        t4 = {
            "source": "searching",
            "target": "final",
        ...
        would_you_like_to_charge = {
            "name": "would_you_like_to_charge",
            "entry": "start_timer('t0', '30000')",
            "exit": "stop_timer('t0')",
        }
        ...
        self.stm = stmpy.Machine(
            ...
            obj=self,
            states=[searching, would_you_like_to_charge],
        )
    ...
    def send_message_to_scooter(self):
        ...
        self.component.mqtt_client.publish(
            MQTT_TOPIC_SCOOTER, """{"msg": "would_you_like_to_charge"}"""
        )

    def give_discount_2(self):
        self.component.mqtt_client.publish(
            MQTT_TOPIC_SCOOTER, """{"msg": "2_percent"}"""
        )

    def give_discount_5(self):
        self.component.mqtt_client.publish(
            MQTT_TOPIC_SCOOTER, """{"msg": "5_percent"}"""
        )
    ...
    def measure_distance(self):
        ...
        self.component.mqtt_client.publish(
            MQTT_TOPIC_CHARGER, """{"msg": "found_scooter"}"""
        )
