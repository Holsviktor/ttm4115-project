...
class ScooterAppApp(App):
    ...
    def build(self):
        ...
        # Remove and replace by reading from the server, JANNA

        #for i in range(0, 2):
        #    r_lat = 63.389189 + random() * (63.447261-63.389189)
        #    r_lon = 10.329052 + random() * (10.476090-10.329052)
        #    self.map_disp.add_widget(self.create_cg(r_lat, r_lon))
    ...
    def on_start(self):
        ...
        # 5 - In Drive State
        # 6 - Scooter Error
        self.C_STATE_CTRL   = [0, 0, 0, 0, 0, 0, 0]
        self.QR_MSG         = 0
        self.C_SCOOTER_LIST = [None]
        self.C_SCOOTER_RESV = [None]
        ...
        try:
            if msg is not 0 and msg['user_name'] == self.MQTT_Client.username:
                try:
                    ...
                    elif msg['msg'] == 'single_not_avaible':
                        print("Error...")
                        self.remove_selected(msg['scooter_name'])
                    elif msg['msg'] == 'multiple_not_avaible':
                        print("Error...")
    ...
    #? Is this even needed when chck_app exists?
    def stop_ride(self):
        None
        #TODO: Sub to topic on MQTT

        #TODO: Transmit data that ride was ended
